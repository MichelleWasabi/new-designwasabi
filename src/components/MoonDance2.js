...
export default () => {
  ...
  const tween = () => {
    gsap.to("#moon", {
      ...
      motionPath: {
        path: "#bottom-circle",
        align: "#bottom-circle",
        alignOrigin: [0.5, 0.79],
        // autoRotate: false,
        
      },
    });
    
    gsap.from("#blinks", {duration: 1, autoAlpha: 1, repeat: 10, ease: "none", yoyo:true, repeatDelay: 1});
  ...
  return (
    <div className="container">
      <svg width="1150px" height="500px" viewBox="-80 65 900 500" id="svg">
